    ...
    <table class="table table-border table-bordered table-hover table-bg" id="table-sort">
        ...
        <tbody>
            <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="text-c">
                ...
                <td><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["goodsImg"]); ?>" width="50px" height="50px" alt="" /></td>
                <td><img src="/jiu_xiangmu/xiangmu/jiu/Public/homeIcon/<?php echo ($val["cm_grade"]); ?>.jpg" width="100" height="25"></td>
