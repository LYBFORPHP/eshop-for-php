...
<article class="page-container">
	<form action="<?php echo U('Admin/Inmail/deal_reply');?>" class="form form-horizontal" id="form-admin-add" method="post" >
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">收件人：</label>
		<div class="formControls col-xs-8 col-sm-6"> <span class="select-box" style="width:150px;">
			<select class="select" name="adminRole" size="1">
				
				
					<option value="<?php echo ($data['Inm_fjid']); ?>,<?php echo ($data['Inm_fjname']); ?>"><?php echo ($data['Inm_fjname']); ?> </option>
	...
	<input type="hidden" name="Inm_fjid" value="<?php echo ($data['Inm_sjid']); ?>">
	<input type="hidden" name="Inm_fjname" value="<?php echo ($data['Inm_sjname']); ?>">
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">内容：</label>
		<div class="formControls col-xs-8 col-sm-6">
			<textarea name="content" cols="" rows="" class="textarea"  placeholder="说点什么...1000个字符以内" dragonfly="true" onKeyUp="textarealength(this,1000)"></textarea>
			<p class="textarea-numberbar"><em class="textarea-length">0</em>/1000</p>
		</div>
	</div>
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;回复&nbsp;&nbsp;"> &nbsp;&nbsp;<input class="btn btn-primary radius" type="reset" value="&nbsp;&nbsp;重置&nbsp;&nbsp;">
		</div>
	</div>
	</form>
</article>
