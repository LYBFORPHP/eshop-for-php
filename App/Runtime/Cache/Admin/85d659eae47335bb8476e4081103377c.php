...
<article class="page-container">
    <form action="<?php echo U('Admin/Goods/edit_icon');?>" class="form form-horizontal" id="form-admin-add" method="post" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <img width="100px" src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($data[0]['picture']); ?>" alt="">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="input-text" name="picture" id="id" >
            </div>
        </div>
