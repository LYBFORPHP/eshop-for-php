...
<article class="page-container">
    <form action="<?php echo U('Admin/Goods/not_icon');?>" class="form form-horizontal" id="form-admin-add" method="post" enctype="multipart/form-data">
        <div><input type="hidden" name="id" value="<?php echo ($data[0]['id']); ?>"></div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>当前详情图：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <img width="100px" height="100px" src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($data[0]['not_icon']); ?>" alt="">
            </div>
        </div>
        
        
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>修改详情图：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="input-text" name="not_icon" id="id" >
            </div>
        </div>
