    ...
    <table class="table table-border table-bordered table-hover table-bg" id="table-sort">
        ...
        <tbody>
            <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="text-c">
                ...
                <td><a title="编辑头像" href="javascript:;" onclick="Goods_role_edit('商品图片编辑','edit_icon.html?id=<?php echo ($val["id"]); ?>')" style="text-decoration:none"><i class="Hui-iconfont"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="60" height="60"></td>
...
<!--                  <td><a title="编辑头像" href="javascript:;" onclick="admin_role_edit('管理员编辑','edit_icon.html?id=<?php echo ($val["ad_id"]); ?>','500' ,'400')" style="text-decoration:none"><i class="Hui-iconfont"><img src="/jiu_xiangmu/xiangmu/jiu/Public/adminerIcon/<?php echo ($val["not_icon"]); ?>" width="50"></i></a></td> -->
                <td>
                <a title="编辑头像" href="javascript:;" onclick="Goods_role_edit('商品图片编辑','not_icon.html?id=<?php echo ($val["id"]); ?>')" style="text-decoration:none"><i class="Hui-iconfont"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["not_icon"]); ?>" width="60" height="60">
                </td>
