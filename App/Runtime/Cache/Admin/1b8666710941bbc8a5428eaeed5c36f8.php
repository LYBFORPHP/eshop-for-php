...
<div class="page-container">
	...
	<table  class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr class="text-c">
				...
				<td><?php echo ($val['Inm_sjid']); ?></td>
				<td><?php echo ($val['Inm_sjname']); ?></td>
				<td><?php echo ($val['Inm_title']); ?></td>
				<td><?php echo ($val['Inm_content']); ?></td>
				<?php if($val[Inm_status] == '未读'): ?><td style="color:red">对方<?php echo ($val['Inm_status']); ?></td>
				<?php else: ?>
				<td style="color:green">对方<?php echo ($val['Inm_status']); ?></td><?php endif; ?>		
				<td><?php echo ($val['Inm_sendtime']); ?></td>
				<td class="td-manage">
				<?php if($val[Inm_status] == '未读'): ?><a title="删除" href="javascript:;"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
				<?php else: ?>
					<a title="删除" href="javascript:;" onclick="del_inmail(this,<?php echo ($val["Inm_id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; ?>
