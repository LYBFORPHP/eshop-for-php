...
<article class="page-container">
	<form action="<?php echo U('Admin/Inmail/deal_send');?>" class="form form-horizontal" id="form-admin-add" method="post" >
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-6"> <span class="select-box" style="width:150px;">
			<select class="select" name="adminRole" size="1">
				<?php if(is_array($list)): foreach($list as $key=>$val): ?><option value="<?php echo ($val['ad_id']); ?>,<?php echo ($val['ad_adminer']); ?>"><?php echo ($val['ad_adminer']); ?> </option><?php endforeach; endif; ?>
	...
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;"> &nbsp;&nbsp;<input class="btn btn-primary radius" type="reset" value="&nbsp;&nbsp;重置&nbsp;&nbsp;">
		</div>
	</div>
	</form>
</article>
