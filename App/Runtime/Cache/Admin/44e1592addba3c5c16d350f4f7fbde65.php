...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 友情链接 <span class="c-gray en">&gt;</span>查看友情链接 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    
    <table class="table table-border table-bordered table-hover table-bg" id="table-sort">
        <thead>
            <tr>
                <th scope="col" colspan="14">友情链接浏览</th>
            </tr>
            <tr class="text-c">
        ...
        <tbody>
            <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="text-c">
                ...
                <td><?php echo ($val["Fri_id"]); ?></td>
                <td><?php echo ($val["Fri_name"]); ?></td>
                 <td><?php echo ($val["Fri_url"]); ?></td>
                  <td><?php echo ($val["Fri_describe"]); ?></td>
                <td><?php echo ($val["Fri_linktime"]); ?></td>
                <td class="td-manage">
              
                <a title="修改" href="javascript:;" onclick="Goods_role_edit('修改','edit.html?id=<?php echo ($val["Fri_id"]); ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="Frilink_role_del(this,<?php echo ($val["Fri_id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function Frilink_role_del(obj,id){
    layer.confirm('数据价值高，删除需谨慎，确认要删除吗？',function(index){
        ...
        $.get("<?php echo U('Admin/Frilink/del');?>",{'Fri_id':id},function(data){
            if(data.status == '1'){
                $(obj).parents("tr").remove();
                layer.msg('已删除!',{icon:1,time:1000});
