...
<link rel="stylesheet" type="text/css" href="/jiu_xiangmu/xiangmu/jiu/Public/Home/css/main.css" />
<link type="text/css" rel="stylesheet" href="/jiu_xiangmu/xiangmu/jiu/Public/css/show.css">
 	...
 	<div class="container">
			        ...
			        <ul class="cate-nav-ul1">
						<?php if(is_array($cate_list)): foreach($cate_list as $key1=>$val1): if($val1[pid] == 1): ?><li class="cate-nav-li1">
			                ...
			                <div class="cate-hidden-two1">
								...
								<div class="zhanshi"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/123.png" alt=""></div>
			                </div>
		...
		<div class="out">
			<ul style="margin-left:-550px;" class="img">
				<?php if(is_array($list)): foreach($list as $key=>$val): ?><li><a href=""><img src="/jiu_xiangmu/xiangmu/jiu/Public/carouselimage/<?php echo ($val["cal_image"]); ?>" alt=""></a></li><?php endforeach; endif; ?>
	        </ul>
	        <ul class="num">
				<li>1</li>
				<li>2</li>
	...
	<div class="todayHot" style="height: 100px; ">
		<div class="todayHot-1"><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-19_201321.png" alt=""></div>
	...
	<div class="big_Box" style="width:1206px;height:280px;border:1px solid white">
		<?php if(is_array($todayHot)): foreach($todayHot as $key=>$val): ?><ul onmouseout="small_boss(this,<?php echo ($val["id"]); ?>)" onmouseover="Big_boss(this,<?php echo ($val["id"]); ?>)" style="float:left;width:200px;height:280px;text-align:center;position:relative;border:1px solid gray"><a href="<?php echo U('Home/Goodsdetail/index',array(id => $val['id']));?>" >
			<li class='sp-picture'><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width='195' height='195' alt=""></li>
	...
	<div class="todayHot" style="height:50px">
		<div class="todayHot-1"><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-20_111353.png" alt=""></div>
	...
	<div class='tabs'>
		...
		<div class="main">
	        <div class="tab" style="display:block;">
				<div class="big-img"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481683027168305.png" alt=""></div>
				<?php if(is_array($lexiang)): foreach($lexiang as $key=>$val): ?><div onmouseout="small_boss(this,<?php echo ($val["id"]); ?>)" onmouseover="Big_boss(this,<?php echo ($val["id"]); ?>)" style="width:360px;height:210px;border-top:none;border:1px solid gray;float: left;position:relative"><a href="<?php echo U('Home/Goodsdetail/index',array(id => $val['id']));?>">
						<div class='sp-picture' style="width:200px;height:209px;float:left"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="198" height="206px" alt=""></div>
	        ...
	        <div class="tab" >
				<div class="big-img"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1482142259714561.png" alt=""></div>
				<?php if(is_array($renqi)): foreach($renqi as $key=>$val): ?><div onmouseout="small_boss(this,<?php echo ($val["id"]); ?>)" onmouseover="Big_boss(this,<?php echo ($val["id"]); ?>)" style="width:360px;height:210px;border-top:none;border:1px solid gray;float: left;position:relative"><a href="<?php echo U('Home/Goodsdetail/index',array(id => $val['id']));?>">
						<div style="width:200px;height:208px;float:left"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="198" height="206px" alt=""></div>
						<div style="width:157px;float:left;margin-top:85px;text-align:center;font-size:2px;color:black;font-family:微软雅黑"><?php echo ($val["name"]); ?></div>
	        ...
	        <div class="tab" >
				<div class="big-img"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481683097072118.png" alt=""></div>
	        ...
	        <div class="tab" >
				<div class="big-img"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1479260955739647.png" alt=""></div>
	        ...
	        <div class="tab" >
				<div class="big-img"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481770360752948.png" alt=""></div>
	...
	<div class="todayHot">
		<div class="todayHot-1"><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-20_165722.png" alt=""></div>
	...
	<div style="float:left;border:1px solid gray">
		<img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481684142012371.png" alt="">
	</div>
	<div style="float:left;border:1px solid gray">
		<img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1480390238790862.png" alt="">
	</div>

	<div style="float:left;border:1px solid gray">
		<img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481684605926234.png" alt="">
	</div>

	<div style="float:left;border:1px solid gray">
		<img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1478512099064785.png" alt="">
	</div>
	<div style="clear:both"></div><br>
	<br>
	...
	<div class="public-box">
		...
		<div class="left-box"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481694604908169.png" alt=""></div>
		<div class="center-box">
			<?php if(is_array($putao)): foreach($putao as $key=>$val): ?><div onmouseout="small_boss(this,<?php echo ($val["id"]); ?>)" onmouseover="Big_boss(this,<?php echo ($val["id"]); ?>)" style="width:189px;height:230px;border:1px solid gray;float: left;overflow: hidden;position:relative">
				<div><a href="<?php echo U('Home/Goodsdetail/index',array(id => $val['id']));?>">
					<img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="188" height="179px" alt="">
				</div>
		...
		<div class="left-box"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481695235727838.png" alt=""></div>

		<div class="zhezhao"><a href="#"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481695334589614.jpg" alt=""></a></div>
	</div><br><br>
	...
	<div class="public-box">
		...
		<div class="left-box"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481695224255200.png" alt=""></div>
		<div class="center-box">
		...
		<div class="left-box"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1482117014222541.png" alt=""></div>

		<div class="zhezhao"><a href="#"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481695393652826.jpg" alt=""></a></div>
	</div><br>
	...
	<div class="public-box">
		...
		<div class="zhezhao"><a href="#"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/1481695794856413.jpg" alt=""></a></div>
	</div><br><br><br><hr>
<!--            这里是楼层展示                     -->
...
<script src="/jiu_xiangmu/xiangmu/jiu/Public/js/jquery.scrollpic.js" type="text/javascript"></script>
<script src="/jiu_xiangmu/xiangmu/jiu/Public/js/TabSwitch.js" type="text/javascript"></script>
<script>
