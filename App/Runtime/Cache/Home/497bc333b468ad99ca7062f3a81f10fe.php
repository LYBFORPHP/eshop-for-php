...
<link rel="stylesheet" type="text/css" href="/jiu_xiangmu/xiangmu/jiu/Public/css/show.css" />
<link rel="stylesheet" type="text/css" href="/jiu_xiangmu/xiangmu/jiu/Public/css/bootstrap.min.css" />
<script type="text/javascript" src="/jiu_xiangmu/xiangmu/jiu/Public/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/jiu_xiangmu/xiangmu/jiu/Public/js/jquery-2.1.3.min.js"></script>
		...
		<?php if(is_array($list)): foreach($list as $key=>$val): ?><a href="<?php echo U('Home/Goodsdetail/index',array(id => $val['id']));?>">
			...
			<div onmouseout="small_boss(this,<?php echo ($val["id"]); ?>)" onmouseover="Big_boss(this,<?php echo ($val["id"]); ?>)" style="margin:10px 50px;border:1px solid yellow;width:200px;border:1px solid gray;height:280px;float:left;overflow:hidden;position:relative;">
				<div class="todayHot-goods-1" style="height:285px">
					<div class="goods-image"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width='195' height="200" alt=""></div>
