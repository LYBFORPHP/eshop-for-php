...
<link href="/jiu_xiangmu/xiangmu/jiu/Public/Home/css/common.css" rel="stylesheet" type="text/css" />
<link href="/jiu_xiangmu/xiangmu/jiu/Public/Home/css/goodsdetail.css" rel="stylesheet" type="text/css" />
<script src="/jiu_xiangmu/xiangmu/jiu/Public/Home/js/jquery-1.9.1.min.js"></script>
<script src="/jiu_xiangmu/xiangmu/jiu/Public/Home/js/common.js"></script>
<link rel="stylesheet" type="text/css" href="/jiu_xiangmu/xiangmu/jiu/Public/Home/css/main.css" />
<link rel="stylesheet" type="text/css" href="/jiu_xiangmu/xiangmu/jiu/Public/Home/css/left.css" />
<link type="text/css" rel="stylesheet" href="/jiu_xiangmu/xiangmu/jiu/Public/css/show.css">
    ...
    <style>
      .prea_tu{
        ...
        /*border:1px solid red;*/
         cursor:pointer;
        background-image:url("/jiu_xiangmu/xiangmu/jiu/Public/Home/images/d_e.jpg");
      }
      .wai-1{
                  width:30px;
                  height:25px;
                  /*border:1px solid red;*/
                  float: left;
                   background-image:url("/jiu_xiangmu/xiangmu/jiu/Public/Home/images/d_i.jpg");
                }
    ...
    <!-- 主体的左边 -->
       <a name="top"></a>    
          <div id="o_left">
            ...
            <div id="showbox">
              <!--         商品图          -->
              <img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="300" height="300" />
            </div>
          <!--展示图片盒子-->
    ...
    <!-- 左边商品推荐 -->
      <div class="buju_left">
            ...
            <div class="buju_left1">
                ...
                <div class="left_s1">
                      <dt class="left_zt1"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="70" height="80" /></dt>
            ...
            <div class="buju_left2">
                ...
                <div class="left_x1">
                      <dt class="left_xt1"><img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($val["picture"]); ?>" width="70" height="80" /></dt>
    ...
    <div style=" width:950px;height:1800px;margin-left:249px;">
            <img src="/jiu_xiangmu/xiangmu/jiu/Public/goodsimage/<?php echo ($data[0][not_icon]); ?>" style="width:900px;height:1790px;">
    </div>
    ...
    <div class="goodscomment" style=" #ccc;height:730px;margin-top:70px;background-color:#EFEFEF;position:absolute;top:560px;left:0">
      ...
      <div style="background:#EFEFEF">
        ...
        <ol style="background-color:white;">
            <li><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_01.jpg" style="width:895px;height:558px;"></li>
            <li>
            ...
            <dt><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_05.jpg" style="width:895px;height:358px;"></dt>
            </li>
            <li>
                  ...
                  <dt><b style="font-size:20px"  class="guapai2">专业的客服团队</b><br><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_02.jpg" style="width:895px;height:280px;"></dt>
            </li>
            <li>
                  ...
                  <dt> <img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_08.jpg" style="width:895px;height:250px;"></dt>
            </li>
            <li>
            ...
            <dt class="kefu2"> <img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_06.jpg" style="width:895px;height:458px;"></dt>
            </li>
            <li>
            <dt class="zhuanye"><h5>网酒网物流业务全国覆盖，现全国拥有2大物流中心，分别为北京，宁波，仓库的专业及高科技化管理方式，配送队伍高效及严谨工作方法，仓配之间的无缝衔接， 100%保证订单能高速准确的送达您的手中。<h5></dt>
            <dt> <img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/images/enc_07.jpg" style="width:895px;height:500px;"></li></dt> 
        </ol>
    </div>
      </div>
    </div>
