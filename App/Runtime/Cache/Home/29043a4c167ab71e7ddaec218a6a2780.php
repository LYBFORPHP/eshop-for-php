<?php if (!defined('THINK_PATH')) exit();?><html lang="en">
	...
	<body>
		<div style="height:100px;background:#FFFFFF;">
			<div style="float:left;margin-left:50px;margin-top:30px"><a href="<?php echo U('Home/index/show');?>"><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-16_215120.png" height="60" alt=""></a></div>
			
		</div>

		<div style="margin:0 auto;background: url('/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-16_222623.png');position:relative; " >
		<div class="container" style="">
			<div style="position:absolute;left:250px;top:205px;width:241px;height:59px;background:white"><img src="/jiu_xiangmu/xiangmu/jiu/Public/Home/pic/2016-12-16_214959.png" width="241" height="58"  alt=""></div>
			<div class="row">
	...
	<script src="/jiu_xiangmu/xiangmu/jiu/Public/geetest/geetest.js"></script>
    <script src="/jiu_xiangmu/xiangmu/jiu/Public/js/jquery-2.1.3.min.js"></script>
    <script>
